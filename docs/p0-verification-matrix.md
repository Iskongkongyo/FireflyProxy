...
- Browser Core、HTML/CSS Rewrite 与 Cookie Jar 已在后续 P1 门禁完成；Runtime Bridge、WebSocket 与可选 Origin Isolation 已在后续 P2 4.2–4.4 完成。高级 Worker/Service Worker 兼容仍属于后续里程碑。
- 仓库尚无正式 `LICENSE` 文件。
