const ERROR_CODES = Object.freeze({
    ...
    REQUEST_CONTROL_INVALID: "PROXY_REQUEST_CONTROL_INVALID",
    CONCURRENCY_LIMIT: "PROXY_CONCURRENCY_LIMIT",
    CLIENT_BLOCKED: "PROXY_CLIENT_BLOCKED",
    AUDIT_UNAVAILABLE: "PROXY_AUDIT_UNAVAILABLE",
    BROWSER_DISABLED: "PROXY_BROWSER_DISABLED",
    BROWSER_URL_INVALID: "PROXY_BROWSER_URL_INVALID",
    ORIGIN_ISOLATION_DENIED: "PROXY_ORIGIN_ISOLATION_DENIED",
    WEBSOCKET_DISABLED: "PROXY_WEBSOCKET_DISABLED",
    WEBSOCKET_AUTH_REQUIRED: "PROXY_WEBSOCKET_AUTH_REQUIRED",
    WEBSOCKET_ORIGIN_DENIED: "PROXY_WEBSOCKET_ORIGIN_DENIED",
    ROUTE_NOT_FOUND: "PROXY_ROUTE_NOT_FOUND",
    ...
    ADMIN_DISABLED: "PROXY_ADMIN_DISABLED",
    ADMIN_AUTH_REQUIRED: "PROXY_ADMIN_AUTH_REQUIRED",
    ADMIN_ORIGIN_DENIED: "PROXY_ADMIN_ORIGIN_DENIED",
    ADMIN_CONFIG_INVALID: "PROXY_ADMIN_CONFIG_INVALID",
    ADMIN_RATE_LIMIT: "PROXY_ADMIN_RATE_LIMIT",
    RUNTIME_STATE_UNAVAILABLE: "PROXY_RUNTIME_STATE_UNAVAILABLE",
